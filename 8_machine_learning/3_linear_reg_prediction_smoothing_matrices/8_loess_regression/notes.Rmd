...
$$
W(u) = (1 - \vert{u}\vert^3)^3\ \ \mathbf{if}\ \vert{u}\vert \le1 \\
\mathbf{and} \\
W(u) = 0\ \ \mathbf{if} \vert{u}\vert > 1
$$
...
$$
E\left[Y_i\ \vert\ X_i=x_i\right] = \beta_0 + \beta_1(x_i-x_0) + \beta_2(x_i - x_0)^2 \\ \mathrm{\mathbf{if\ }} \vert{x_i - x_0}\vert \le h
$$
